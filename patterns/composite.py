...
def client_code2(component1: Component, component2: Component) -> str:
    """
    ...
    return f"RESULT: {component1.operation()}\n"
...
def get_data():
    ...
    str_return += "Client: Now I've got a composite tree:\n"
    str_return += client_code(tree)

    str_return += "Client: I don't need to check the components classes even when managing the tree:\n"
    str_return += client_code2(tree, simple)
    return str_return + "\n"
