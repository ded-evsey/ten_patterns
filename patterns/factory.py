...
def client_code(creator: Creator) -> str:
    ...
    return f"Client: I'm not aware of the creator's class, but it still works.\n"+f"{creator.some_operation()}"


def get_data():
    str_return = "App: Launched with the ConcreteCreator1.\n"
    str_return += client_code(ConcreteCreator1()) + '\n'
    str_return += "App: Launched with the ConcreteCreator2.\n"
    return str_return + client_code(ConcreteCreator2())+'\n'
