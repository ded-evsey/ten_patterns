...
def get_data():
    ...
    str_return = "Standard basic product: \n"
    director.build_minimal_viable_product()
    str_return += builder.product.list_parts() + '\n'

    str_return += "Standard full featured product: \n"
    director.build_full_featured_product()
    str_return += builder.product.list_parts() + '\n'
    # паттерн Строитель можно использовать без класса Директор.
    str_return += "Custom product: \n"
    builder.produce_part_a()
    builder.produce_part_b()
    return str_return + builder.product.list_parts() + '\n'
